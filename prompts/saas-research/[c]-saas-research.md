# Complete Copy-and-Paste Deep Research Prompts for LLM-Only SaaS and Third-Party App Research

Each prompt below is fully self-contained. Every one includes:
- master operating instructions
- the high-rigor adversarial review add-on
- the consistent output format

These are designed to be copied and pasted directly into an LLM for deep research conducted entirely through public information, with no interviews, surveys, or direct human fieldwork.
...
```text
Conduct deep research using only publicly available information. Do not use interviews, surveys, invented examples, or unsupported speculation. Use current sources where recency matters. Distinguish clearly between:
1. verified facts,
...
Now conduct deep research on the question: “What kinds of SaaS products and third-party apps will customers still be willing to pay for even as AI-assisted coding and agentic software creation become more accessible to non-coders?”
...
Now conduct deep research on the durable moats available to SaaS founders and third-party app developers in a world where software generation is becoming easier.
...
Now conduct deep research on which third-party app ecosystems still present strong commercial opportunity for independent developers and small teams.
...
Now conduct deep research on software problems that customers could theoretically build or patch together themselves using AI and no-code tools, but in practice still prefer to pay someone else to solve.
...
Now conduct deep research on how to identify commercially meaningful white space inside crowded software categories.
...
- how to detect underserved segments through public evidence,
...
Now conduct deep research on modern build-vs-buy dynamics for software buyers in 2026, especially in contexts where AI coding tools and agentic systems have lowered perceived build costs.
...
Now conduct deep research on how to identify high-value workflow pain using only publicly available information.
...
Now conduct deep research on what types of SaaS products are best suited to solo founders or small teams in the AI era.
...
Now conduct deep research on why buyers regret SaaS purchases and how those regret patterns create openings for better products.
...
Now conduct deep research on how security, trust, governance, auditability, and operational accountability function as commercial differentiators for SaaS and third-party apps.
...
Now conduct deep research on the difference between AI features that create real commercial value and AI features that amount to commodity noise.
...
Now conduct deep research to create a rigorous framework for selecting one SaaS or third-party app idea that is worth building in the current market.
...
Now conduct deep research on how a SaaS founder can perform competitive intelligence using only public information.
...
Now conduct deep research on whether independent software builders are better served today by pure SaaS, productized services, or hybrid software-plus-service models.
...
Now conduct deep research on how to identify SaaS and third-party app opportunities hidden inside workflows that are still managed manually, through spreadsheets, ad hoc procedures, checklists, email coordination, or internal admin labor.
...
1. Prompt 1 — market durability
2. Prompt 2 — moat analysis
3. Prompt 3 — ecosystem selection
4. Prompt 4 — build-versus-buy psychology from the customer side
5. Prompt 5 — white space detection
6. Prompt 6 — explicit build-vs-buy dynamics
7. Prompt 7 — workflow pain discovery
8. Prompt 8 — small-team category selection
9. Prompt 9 — regret pattern analysis
10. Prompt 10 — trust and governance moat analysis
11. Prompt 11 — AI-feature discipline
12. Prompt 12 — final decision framework
13. Prompt 13 — competitor intelligence
14. Prompt 14 — business model selection
15. Prompt 15 — manual-operations opportunity discovery
16. Prompt 16 — idea red-team

---

## Optional Note

If you want, the next refinement should be a second document that restructures these into three specialized families:
- ecosystem opportunity research prompts
- product selection and monetization prompts
- competitor and moat warfare prompts

That version would be better for repeated founder use inside a research workflow.
